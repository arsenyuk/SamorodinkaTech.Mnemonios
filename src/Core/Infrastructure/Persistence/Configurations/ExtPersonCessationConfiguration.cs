...
/// <summary>
/// Конфигурация EF Core для сущности ExtPersonCessation.
/// </summary>
public class ExtPersonCessationConfiguration : IEntityTypeConfiguration<ExtPersonCessation>
{
    /// <inheritdoc/>
    public void Configure(EntityTypeBuilder<ExtPersonCessation> builder)
    {
        builder.ToTable("ext_person_cessations");
        ...
        builder.HasIndex(e => e.SourceSystemId).HasDatabaseName("ix_ext_person_cessations_source_system_id");
